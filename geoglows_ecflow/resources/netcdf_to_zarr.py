...
def netcdf_forecasts_to_zarr(ecflow_home: str, vpu: str) -> None:
    ...
    with open(os.path.join(ecflow_home, "rapid_run.json"), "r") as f:
        ...
        for date in data["dates"].keys():
            ...
            forecast_nc_list = glob(
                os.path.join(forecast_dir, f"Qout_{vpu}*.nc")
            )
...
if __name__ == "__main__":
    ...
    vpu = sys.argv[2]
    netcdf_forecasts_to_zarr(ecflow_home, vpu)
